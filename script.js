...
console.log('%cCe site a été développé avec passion en HTML, CSS et JavaScript.', 'font-size: 14px; color: #6b7280;');
console.log('%cN\'hésitez pas à me contacter pour vos projets !', 'font-size: 14px; color: #10b981;');
